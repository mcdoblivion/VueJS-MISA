                    ...
                    <div class="m-row m-flex">
                        ...
                        <div class="m-col el-left m-flex-4">
                            ...
                            <div class="m-row m-flex">
                                <div class="m-col m-flex-1">
                                    <div class="m-label">
                                        Email (<span class="label-required"
                                            >*</span
                                        >)
                                    </div>
                                    <div class="m-control">
                            ...
                            <div class="m-row m-flex">
                                <div class="m-flex-1">
                                    ...
                                    >
                                        <option
                                            value="19165ed7-212e-21c4-0428-030d4265475f"
                                        >
                                            Giám đốc
                                        </option>
                                        <option
    ...
    data() {
        return {
            ...
            employee: {
                ...
                Address:
                    "319 Prospect Hill Blvd, Keith Bldg, Boise, Idaho, 76994",
